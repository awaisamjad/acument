...
<div id="splash-screen">
	<div class="logo-container">
		<img src={Asset_5_300x} alt="Company Logo" />
	</div>
...
<nav class="navbar is-spaced is-transparent">
	<div class="navbar-brand">
		<a href="" class="navbar-item" id="brand-logo">
			<img
				src="/src/assets/acument_design/acument/logo/300ppi/asset_10_300x.png"
				alt="Logo"
				id="nav-logo"
			/>
		</a>
...
<section class="hero is-small scroll-snap" style="padding: 0rem">
	<div class="hero-body center-div">
		...
		<img
			src="/src/assets/acument_design/acument/images_for_website/AdobeStock_240945219.jpeg"
			id="hero-img"
			alt="Adobe Stock"
		/>
	</div>
...
<style lang="scss">
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-bold.otf')
			format('opentype');
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-demibold.otf')
			format('opentype');
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-extrabold.otf')
			format('opentype');
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-heavy.otf')
			format('opentype');
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-light.otf')
			format('opentype');
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-medium.otf')
			format('opentype');
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-regular.otf')
			format('opentype');
	...
	@font-face {
		...
		src: url('/src/assets/font/Greycliff_Fonts/Greycliff_Fonts/greycliffcf-thin.otf')
			format('opentype');
